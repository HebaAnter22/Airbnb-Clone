...
namespace API.Services
{
    public interface IPropertyService
    {
        ...
        Task<(List<PropertyDto> Properties, int Total)> GetAllPropertiesAsync(int page, int pageSize, int? categoryId = null, decimal? minPrice = null, decimal? maxPrice = null, int? excludeHostId = null);
        ...
        Task<List<PropertyDto>> SearchPropertiesAsync(string title = null, string country = null, int? minNights = null, int? maxNights = null, DateTime? startDate = null, DateTime? endDate = null, int? maxGuests = null, int? excludeHostId = null, int? page = null, int? pageSize = null, int? categoryId = null);
